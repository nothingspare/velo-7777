    ...
    cards: [
      ...
      },
      {
        ...
        tips: [
          ...
          { text: "For OAuth2, set the redirect URI to http://localhost:7777 in your app registration." },
      ...
      },
      {
        ...
        tips: [
          ...
          { text: "Redirect URI must be exactly: http://localhost:7777" },
